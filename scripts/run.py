...
#srun --nodes=1 --ntasks=1 --gpus=1 --time=01:00:00 --partition=defq --export=ALL --container-image=/home/iven.schlegelmilch/ivenschlegelmilch+gorillawatch+1.2.1.sqsh --container-mounts=/home/iven.schlegelmilch/bachelor_thesis_code/:/workspace/bachelor_thesis_code,/mnt/vast-gorilla/:/workspace/vast-gorilla --container-workdir=/workspace --pty bash     
