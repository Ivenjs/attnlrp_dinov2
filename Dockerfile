...
# -----------------
FROM --platform=linux/ppc64le nvidia/cuda:12.2.2-cudnn8-devel-ubi8 as ppc64leubi8
...
# environment activated, then do this:
    ...
    #RUN micromamba run -n research pip install flash_attn --no-deps --no-cache-dir
    
    # Use our environment `research` as default
    ENV ENV_NAME=research
    
    # Install drop_layer_norm for InternVideo. Needs to happen here since it requires pip
    USER ${MAMBA_USER}
