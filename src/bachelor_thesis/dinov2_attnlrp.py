...
from patch_dino import patch_dinov2_for_lrp, dino_batchnorm1d_forward
...
def get_relevances(save_heatmaps: bool = False) -> tuple[torch.Tensor, list[torch.Tensor]]:
    ...
    image = Image.open("/workspaces/bachelor_thesis_code/seg_test_in/NN00_R019_20221212_281_378_287939.png").convert("RGB")
